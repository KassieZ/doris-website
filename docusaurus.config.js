...
const config = {
    ...
    themeConfig:
        ...
        ({
            announcementBar: {
                id: 'support_us',
                content: `<a href="https://doris-summit.org.cn/?utm_source=doris&utm_medium=website&utm_id=2023" target="_blank" style="display: flex; width: 100%; align-items: center; justify-content: center; margin-left: 4px; text-decoration: none; color: white">Doris Summit Asia 2023 ended triumphantly, let's delve into the highlights! 
